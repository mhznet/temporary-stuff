package com.smoothtiles.input
{
	...
	public class Keyboard extends Input
	{
		...
		private static var instance:Keyboard = null;
		
		public static function getInstance():Keyboard
		{
			if(!instance)
			{
				Keyboard.okToCreate = true;
				Keyboard.instance = new Keyboard();
				Keyboard.okToCreate = false;
			}
			return instance;
		}
		...
		{
			if(!Keyboard.okToCreate)
				throw new Error("Keyboard must not be instantiated");
